...
<table width="100%" cellpadding="10" cellspacing="0" border="0">
  <tr bgcolor="#0d1117">
    <td width="20%" align="center" style="border: 1px solid #30363d; border-radius: 6px;">
      <font size="5" color="#2ea44f"><b>95.2%</b></font>
      <p><b>Test ROC-AUC</b><br><small>Fraud Ensemble Model</small></p>
    </td>
    <td width="20%" align="center" style="border: 1px solid #30363d; border-radius: 6px;">
...
* **Core Paradigms:** Object Detection, Multi-class Image Classification, Semantic Segmentation, Transfer Learning Pipelines, Model Optimization, Video Stream Processing.
...
* **Core Paradigms:** Predictive Modeling, Exploratory Data Analysis (EDA), Statistical Inference, Feature Engineering Pipelines, Class Imbalance Mitigation (Downsampling, Class Weighting).
* **Libraries & Ecosystem:** Pandas, NumPy, Scikit-learn, SciPy, Matplotlib, Seaborn.

### 🧠 Machine Learning & Advanced Ensembles
* **Core Paradigms:** Supervised/Unsupervised Learning, Gradient Boosting Architectures, Hyperparameter Optimization, Cross-Validation Strategies.
...
* **Deployment & Pipelines:** Workflow Orchestration (Apache Airflow), Containerization (Docker), FastAPI, GitHub Actions CI/CD, MLflow, Streamlit, Flask.
...
* **Problem:** Implementing a high-volume anomaly detection pipeline over heavily skewed transactional flows while minimizing false positives in highly imbalanced transaction data (~0.13% fraud rate).
* **Architecture:** Modular predictive pipeline integrating statistical preprocessing, a gradient-boosted ensemble layer, and configurable risk-tier decision thresholds.
* **My Role:** Solo Developer
